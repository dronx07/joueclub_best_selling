...
class ProductRunner:
    ...
    def generate_page_urls(base_url, total_pages):
        ...
        for page in range(1, total_pages + 1):
            urls.append((page, f"{base_url}?pageNumber-3={page}"))
    ...
    async def collect_from_page(self, page_number, url):
        ...
        try:
            ...
            await page.wait_for_selector(
                "a.product__title-card.product-label",
                timeout=30000
            )
            ...
            for i in range(count):
                ...
                name = (await cards.nth(i).get_attribute("title")).strip()
                ...
                price_text = await prices.nth(i).inner_text()
